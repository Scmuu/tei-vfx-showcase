...
const HeroSection = () => {
  return (
    ...
    >
      ...
      >
        <div className="w-24 h-24 rounded-full border-2 border-primary/50 bg-secondary flex items-center justify-center box-glow overflow-hidden">
          <span className="text-muted-foreground text-xs font-body uppercase tracking-wider">PFP</span>
        </div>
      </motion.div>
