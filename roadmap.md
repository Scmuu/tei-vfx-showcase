...
- [x] Replace the profile image with the uploaded full-screen video background.
- [x] Create the minimal home with TEI, bio, Portfolio and Shop links, and existing socials.
- [x] Move existing work into `/portfolio`.
